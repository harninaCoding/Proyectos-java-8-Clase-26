...
public class AnimalMother {
    ...
    public static List<Animal> createAnimales() {
        ...
        animales.add(new Animal("Le�n", 190.5, LocalDate.of(2018, 6, 15), true));
        ...
        animales.add(new Animal("B�falo", 800.3, LocalDate.of(2013, 7, 15), false));
        ...
        animales.add(new Animal("Hipop�tamo", 1500.0, LocalDate.of(2011, 8, 5), false));
        animales.add(new Animal("�guila", 12.5, LocalDate.of(2018, 9, 30), true));
        ...
        animales.add(new Animal("Chimpanc�", 50.0, LocalDate.of(2020, 6, 14), false));
        ...
        animales.add(new Animal("Tuc�n", 3.2, LocalDate.of(2019, 10, 7), false));
        animales.add(new Animal("Ping�ino", 25.6, LocalDate.of(2018, 3, 18), false));
        ...
        animales.add(new Animal("Orangut�n", 55.0, LocalDate.of(2016, 9, 27), false));
